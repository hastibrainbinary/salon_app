...
class AdminForgotOtpScreen extends StatelessWidget {
  AdminForgotOtpScreen({Key? key}) : super(key: key);
  final AdminForgotOtpController controller =
      Get.put(AdminForgotOtpController());
      ...
      body: Column(
        children: [
          ...
          Pinput(
            ...
            onCompleted: (pin) => Get.toNamed(PageRes.adminNewPasswordScreen),
          ),
          SizedBox(height: Get.height * 0.0431),
          Text(
            Strings.didReceive,
