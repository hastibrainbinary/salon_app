...
class _WeeklyDatePickerState extends State<WeeklyDatePicker> {
  ...
  final int _weekIndexOffset = 5100;
          ...
          Expanded(
            child: PageView.builder(
              ...
              onPageChanged: (int index) {
                setState(() {
                  _weeknumberInSwipe = _initialSelectedDay
                      .add(Duration(days: 6 * (index - _weekIndexOffset)))
                      .month;
                });
              },
              scrollDirection: Axis.horizontal,
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              color: isSelected ? Color(0xff94674F) : Colors.transparent,
              border: isSelected
